...
/** Effects
  ...
  **/
  ...
  VocalizeNdiapo: {
    ...
    IconSrc: '../accesslide/img/sound.svg?2',
    val: 0,
    group: 'Gaccess'
  } ,
  ...
  GotoBnext: {
    ...
    IconSrc: '../accesslide/img/next.svg?2',
    val: 0,
    group: 'Gaccess'
  },
  ...
  Noclick:  {
    ...
    IconSrc: '../accesslide/img/click.svg?2',
    val: 1,
    group: 'Gaccess'
  },
  ...
  SumModOn: {
    ...
    IconSrc: '../accesslide/img/summary.svg?2',
    val: 1,
    group: 'Gslide'
  },
  ...
  ModePlan: {
    ...
    IconSrc: '../accesslide/img/plan.svg?2',
    val: 1,
    group: 'Gslide'
  },
  /** Misceallanous **/
  ...
  Bclose: {
    ...
    fallbackClass : 'text',
    fallBackSrcImg:'../accesslide/img/close.svg?2'
  },
  /** Setting navbar
  ...
  **/
  Bprev: {
    ...
    fallbackClass : 'text',
    fallBackSrcImg:'../accesslide/img/prev.svg?2'
  },
  Bnext: {
    id: 'next',
    ...
    fallbackClass : 'text',
    fallBackSrcImg:'../accesslide/img/next.svg?2'
  },
  Select:{
    id: 'tocP',
  ...
  Bselect: {
    ...
    fallbackClass : 'text',
    fallBackSrcImg:'../accesslide/img/goto.svg?2'
  },
  Btoc: {
    id: 'toc',
    ...
    fallbackClass : 'text',
    fallBackSrcImg:'../accesslide/img/summary.svg?2'
  },
  Bconfig: {
    id: 'set',
    ...
    fallbackClass : 'text',
    fallBackSrcImg:'../accesslide/img/settings.svg?2'
  },
  SelectWrapper: {
    id: 'Fgo',
